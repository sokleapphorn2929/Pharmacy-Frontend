...
import API from "../Api/api"; // 🛠️ Imported your API instance

export default function Navbar() {
  const [isOpen, setIsOpen] = useState(false);
  const [cartCount, setCartCount] = useState(0); // 📊 State to store total cart quantity
  ...
  useEffect(() => {
    async function fetchCartCount() {
      ...
      try {
        ...
        // Let's debug exactly what the server sends back to your navbar:
